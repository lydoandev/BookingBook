...
import { View, ScrollView, SectionList, Text, FlatList, StyleSheet, ActivityIndicator } from 'react-native';
      ...
      return (
        <View style={{ flex: 1, margin: 15, }}>
          <SectionList
            ...
            renderItem={(item) => <ListBook data={item.section.data[0].bookList}
            ...
            renderSectionHeader={({ section: { type, data } }) => (
              <TitleSection type={type} data={data[0].bookList} navigateToSeeAll={this.navigateToSeeAll}></TitleSection>
            )}
          />
        </View>
      )
